...
#endif
        [LAYER_CIRCLE_SHADOW] = G_RM_FOG_SHADE_A,                   // LAYER_SHADOW
        [LAYER_CIRCLE_SHADOW_TRANSPARENT] = G_RM_FOG_SHADE_A,                   // LAYER_SHADOW
...
#endif
        [LAYER_CIRCLE_SHADOW] = G_RM_AA_XLU_SURF2,                  // LAYER_SHADOW
        [LAYER_CIRCLE_SHADOW_TRANSPARENT] = G_RM_CLD_SURF2,                  // LAYER_SHADOW
...
#endif
        [LAYER_CIRCLE_SHADOW] = G_RM_ZB_OVL_SURF2,                  // LAYER_SHADOW
        [LAYER_CIRCLE_SHADOW_TRANSPARENT] = G_RM_ZB_CLD_SURF2,                  // LAYER_SHADOW
