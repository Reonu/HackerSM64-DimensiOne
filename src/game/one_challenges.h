...
enum OneChallengeEntries {
    ...
    CHALLENGE_NAME_SLEEPING_PIRANHAS,
...
enum OneChallengeFlags {
    ...
    CHALLENGE_FLAG_TIMER                 = (1U << CHALLENGE_NAME_TIMER),
    CHALLENGE_FLAG_SLEEPING_PIRANHAS     = (1U << CHALLENGE_NAME_SLEEPING_PIRANHAS),
    ...
    CHALLENGE_FLAG_SMOOCH                = (1U << CHALLENGE_NAME_SMOOCH),
};
