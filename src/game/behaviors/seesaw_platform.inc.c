...
static Collision const *sSeesawPlatformCollisionModels[] = {
    NULL,//bitdw_seg7_collision_0700F70C,
    NULL,//bits_seg7_collision_0701ADD8,
    NULL,//bits_seg7_collision_0701AE5C,
    NULL,//bob_seg7_collision_bridge,
    NULL,//bitfs_seg7_collision_07015928,
    NULL,//rr_seg7_collision_07029750,
    NULL,//rr_seg7_collision_07029858,
    NULL,//vcutm_seg7_collision_0700AC44,
};
