...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_GOOMBA, -30, -80, 5990, 0, 0, 0, (0x15), bhvGoomba),
		OBJECT(MODEL_GOOMBA, 224, -80, 5588, 0, 0, 0, (0x15), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -289, 128, 4785, 0, 0, 0, (0x15), bhvGoomba),
		OBJECT(MODEL_GOOMBA, -34, -80, 4139, 0, 0, 0, (0x15), bhvGoomba),
		OBJECT(MODEL_PENGUIN, 58, -80, 9919, 0, 0, 0, (0x15), bhvSmallPenguin),
		OBJECT(MODEL_SNOWMAN_CUSTOM, 544, -80, 7963, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_SNOWMAN_CUSTOM, -663, -80, 7956, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_SNOWMAN_CUSTOM, 544, -80, 7357, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_SNOWMAN_CUSTOM, -663, -80, 7351, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_SNOWMAN_CUSTOM, 544, -80, 6733, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_SNOWMAN_CUSTOM, -663, -80, 6727, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_PENGUIN, -25, -80, 1985, 0, 0, 0, (0x15), bhvTuxiesMother),
		OBJECT(MODEL_NONE, 52, -80, 10203, 0, 0, 0, (0x15 << 16), bhvInstantActiveWarp),
