...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_wf_geo, moving_platform_geo_challenge_10_wf_collision, 412, 2, 590, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_FORWARD << 16) | (0x20 << 8) | (0x11), bhvSplinePlatform, 31),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_wf_geo, moving_platform_geo_challenge_10_wf_collision, 1487, 2, 581, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_FORWARD << 16) | (0x20 << 8) | (0x11), bhvSplinePlatform, 31),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_wf_geo, moving_platform_geo_challenge_10_wf_collision, 3157, 36, -42, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_FORWARD << 16) | (0x20 << 8) | (0x11), bhvSplinePlatform, 31),
		OBJECT(MODEL_STAR, 5156, 11, -125, 0, 0, 0, (0x0E << 24) | (0x11), bhvStar),
		OBJECT(MODEL_NONE, 19, 0, -23, 0, 0, 0, (0x11 << 16), bhvInstantActiveWarp),
		TERRAIN(wf_area_1_collision),
		MACRO_OBJECTS(wf_area_1_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_GRASS),
		TERRAIN_TYPE(TERRAIN_GRASS),
		AREA_SPLINE(wf_area_1_spline_ASplineChallenge0A_004),
