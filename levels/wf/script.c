...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_MR_BLIZZARD, 544, -80, 4204, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_MR_BLIZZARD, -663, -80, 4197, 0, 0, 0, (0x15), bhvMrBlizzard),
		OBJECT(MODEL_NONE, 52, -80, 6444, 0, 0, 0, (0x15 << 16), bhvInstantActiveWarp),
