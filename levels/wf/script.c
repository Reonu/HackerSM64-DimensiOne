...
const LevelScript level_wf_entry[] = {
	...
	AREA(2, wf_area_2),
		...
		WARP_NODE(0x11, LEVEL_WF, 0x01, 0x11, WARP_NO_CHECKPOINT),
		WARP_NODE(0x12, LEVEL_WF, 0x02, 0x12, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_PENGUIN, -401, 0, -727, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, 318, 0, -2230, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, 897, 351, -3813, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, 651, 1302, -6015, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, 635, 1302, -3884, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, -271, 1302, -3066, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, 677, 1302, -2686, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, -359, 1302, -1893, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, 599, 1302, -1376, 0, 0, 0, (0x12), bhvTuxiesMother),
		OBJECT(MODEL_PENGUIN, -288, 1302, -758, 0, 0, 0, (0x12), bhvTuxiesMother),
