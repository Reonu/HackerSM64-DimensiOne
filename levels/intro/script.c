...
const LevelScript level_intro_splash_screen[] = {
    ...
    AREA(/*index*/ 1, intro_geo_splash_screen),
        OBJECT(/*model*/ MODEL_GOOMBA, /*pos*/ -570, -480, 1500, /*angle*/ 0,  50, 0, /*behParam*/ BP(0x60, 0x00, 0x10, 0x0B), /*beh*/ bhvFloombaStartup),
        OBJECT(/*model*/ MODEL_GOOMBA, /*pos*/  570, -480, 1500, /*angle*/ 0, -50, 0, /*behParam*/ BP(0x60, 0x00, 0x90, 0x0B), /*beh*/ bhvFloombaStartup),
    END_AREA(),
    FREE_LEVEL_POOL(),
    ...
    CLEAR_LEVEL(),
    SLEEP(/*frames*/ 2),
    CALL(0, start_challenges),
    // EXIT_AND_EXECUTE_WITH_CODE(/*seg*/ SEGMENT_MENU_INTRO, _introSegmentRomStart, _introSegmentRomEnd, level_intro_mario_head_regular, _introSegmentBssStart, _introSegmentBssEnd),
    SET_REG(/*value*/ LEVEL_BOB),
    EXIT_AND_EXECUTE(/*seg*/ SEGMENT_GLOBAL_LEVEL_SCRIPT, /*script*/ _scriptsSegmentRomStart, /*scriptEnd*/ _scriptsSegmentRomEnd, /*entry*/ level_main_scripts_entry),
};
