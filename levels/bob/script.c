...
const LevelScript level_bob_entry[] = {
	...
	AREA(5, bob_area_5),
		...
		OBJECT(MODEL_BULLET_BILL, -1766, -244, -2, 0, 90, 0, (0x0F), bhvBulletBill),
		MOVING_PLATFORM_WITH_ACTS(BulletBillCannon_geo, BulletBillCannon_collision, -1891, -244, -2, 0, 0, 0, (0x0F), bhvStaticObjectCustom, 31),
		MOVING_PLATFORM_WITH_ACTS(BulletBillCannon_geo, BulletBillCannon_collision, 1867, -244, -2, 0, -32768, 0, (0x0F), bhvStaticObjectCustom, 31),
		MOVING_PLATFORM_WITH_ACTS(BulletBillCannon_geo, BulletBillCannon_collision, 30, -244, -1921, 0, -16384, 0, (0x0F), bhvStaticObjectCustom, 31),
		MOVING_PLATFORM_WITH_ACTS(BulletBillCannon_geo, BulletBillCannon_collision, 30, -244, 2034, 0, 16384, 0, (0x0F), bhvStaticObjectCustom, 31),
		OBJECT(MODEL_BULLET_BILL, 1742, -244, -2, 0, -90, 0, (0x0F), bhvBulletBill),
		OBJECT(MODEL_BULLET_BILL, 30, -244, -1796, 0, 0, 0, (0x0F), bhvBulletBill),
		OBJECT(MODEL_BULLET_BILL, 30, -244, 1909, 0, -180, 0, (0x0F), bhvBulletBill),
