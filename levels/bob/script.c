...
const LevelScript level_bob_entry[] = {
	...
	AREA(6, bob_area_6),
		...
		WARP_NODE(0x07, LEVEL_BOB, 0x06, 0x07, WARP_NO_CHECKPOINT),
		WARP_NODE(0x08, LEVEL_BOB, 0x05, 0x08, WARP_NO_CHECKPOINT),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_geo, moving_platform_geo_collision, 0, 0, 0, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_FORWARD << 16) | (0x14 << 8), bhvSplinePlatform, 31),
