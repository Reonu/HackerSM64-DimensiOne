...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_YELLOW_COIN, -360, -3036, -41, 0, -180, 0, (0x01), bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, -775, -3036, -41, 0, -180, 0, (0x01), bhvYellowCoin),
		MARIO_POS(0x01, 0, -576, -3342, -99),
		OBJECT(MODEL_STAR, -12, -3036, -41, 0, -180, 0, (0x01 << 16) | (0x01), bhvStar),
		OBJECT(MODEL_NONE, -389, -3329, -127, 0, 0, 0, (0x01 << 16) | (0x01), bhvInstantActiveWarp),
