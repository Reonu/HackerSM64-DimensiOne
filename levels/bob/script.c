...
const LevelScript level_bob_entry[] = {
	...
	AREA(6, bob_area_6),
		...
		OBJECT(MODEL_YELLOW_COIN, 753, 648, 3775, 0, 0, 0, (0x0A), bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 753, 648, 3982, 0, 0, 0, (0x0A), bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN, 753, 814, 3873, 0, 0, 0, (0x0A), bhvYellowCoin),
		...
		OBJECT(MODEL_STAR, 753, 219, 4366, 0, 0, 0, (0x07 << 24) | (0x0A), bhvStar),
		...
		OBJECT(MODEL_STAR, 731, 350, -5735, 0, 0, 0, (0x0B), bhvStar),
		OBJECT(MODEL_MARIOS_WING_CAP, 613, 30, -1563, 0, 0, 0, (0x0B), bhvWingCap),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_geo, moving_platform_geo_challenge_10_collision, 2349, 156, -751, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_FORWARD << 16) | (0x10 << 8) | (0x0E), bhvSplinePlatform, 31),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_geo, moving_platform_geo_challenge_10_collision, 2783, 156, 515, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_BACKWARDS << 16) | (0x10 << 8) | (0x0E), bhvSplinePlatform, 31),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_geo, moving_platform_geo_challenge_10_collision, 3221, 156, -751, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_FORWARD << 16) | (0x10 << 8) | (0x0E), bhvSplinePlatform, 31),
		OBJECT(MODEL_PIRANHA_PLANT, 2783, 287, 515, 0, 0, 0, (0x0E << 24) | (0x0E), bhvPiranhaPlant),
		OBJECT(MODEL_PIRANHA_PLANT, 2349, 287, -751, 0, 0, 0, (0x0E << 24) | (0x0E), bhvPiranhaPlant),
		OBJECT(MODEL_STAR, 4115, 42, -186, 0, 0, 0, (0x0E << 24) | (0x0E), bhvStar),
		OBJECT(MODEL_PIRANHA_PLANT, 3221, 287, -751, 0, 0, 0, (0x0E << 24) | (0x0E), bhvPiranhaPlant),
	...
	AREA(7, bob_area_7),
		...
		OBJECT(MODEL_1UP, -211, 389, -415, 0, 0, 0, 0x00000000, bhvHidden1upInPole),
		OBJECT(MODEL_1UP, -1267, 389, -408, 0, 0, 0, 0x00000000, bhvHidden1upInPole),
		OBJECT(MODEL_1UP, -721, 389, -871, 0, 0, 0, 0x00000000, bhvHidden1upInPole),
		OBJECT(MODEL_1UP, -738, 389, 47, 0, 0, 0, 0x00000000, bhvHidden1upInPole),
		MOVING_PLATFORM_WITH_ACTS(moving_platform_geo_challenge_10_geo, moving_platform_geo_challenge_10_collision, -41, -30, 1253, 0, 0, 0, (SPLINE_OBJECT_BHV_AUTO << 24) | (SPLINE_OBJECT_MOVE_BACK_AND_FORTH << 16) | (0x14 << 8) | (0x0A), bhvSplinePlatform, 31),
		OBJECT(MODEL_STAR, 892, 1743, 1126, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_NONE, -725, 713, -405, 0, 0, 0, (0x0C << 16), bhvInstantActiveWarp),
	...
	AREA(8, bob_area_8),
		...
		OBJECT(MODEL_BLACK_BOBOMB, -4458, 389, -91, 0, 0, 0, (0x0D), bhvBobomb),
