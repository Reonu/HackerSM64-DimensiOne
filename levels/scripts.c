...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_OUTLINE_STAR,            outline_star_geo),
    LOAD_MODEL_FROM_GEO(MODEL_OUTLINE_STAR_COLLECTED,  outline_star_collected_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_CLOCK,                   clock_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MR_BLIZZARD,             mr_blizzard_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MR_BLIZZARD_HIDDEN,      mr_blizzard_hidden_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SNOWMAN_CUSTOM,          snowman_custom_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SNOWBALL_CUSTOM,         snowball_custom_geo),
    FREE_LEVEL_POOL(),
    POP_POOL(),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_KOOPA_SHELL,             shell_custom_geo),
...
const LevelScript script_func_global_15[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_KOOPA_WITH_SHELL,        koopa_with_shell_custom_geo),
    LOAD_MODEL_FROM_GEO(MODEL_KOOPA_WITHOUT_SHELL,     koopa_without_shell_custom_geo),
