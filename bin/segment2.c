...
#include "textures/segment2/dimbo.i4.inc.c"
};
...
#include "dimbo.inc.in"

static const u8 small_font_kerning_outline[84] = {
    /*!*/ 3, /*"*/ 4, /*#*/ 0, /*$*/ 0, /*%*/ 6, /*&*/ 6, /*'*/ 1, /*(*/ 4, /*)*/ 4, /***/ 0, /*+*/ 6, /*,*/ 2, /*-*/ 6, /*.*/ 2, /*/*/ 6, /*0*/ 6,
    /*1*/ 6, /*2*/ 6, /*3*/ 6, /*4*/ 6, /*5*/ 6, /*6*/ 6, /*7*/ 6, /*8*/ 6, /*9*/ 6, /*:*/ 2, /*;*/ 2, /*?*/ 6, /*A*/ 6, /*B*/ 6, /*C*/ 6, /*D*/ 6,
    /*E*/ 6, /*F*/ 6, /*G*/ 6, /*H*/ 6, /*I*/ 5, /*J*/ 7, /*K*/ 6, /*L*/ 6, /*M*/ 6, /*N*/ 6, /*O*/ 6, /*P*/ 6, /*Q*/ 6, /*R*/ 6, /*S*/ 6, /*T*/ 6,
...
static const u8 small_font_kerning_plain[84] = {
...
static const u8 small_font_kerning_vanilla[84] = {
...
const u8 *const puppyprint_kerning_lut[][94] = {
    Dimbo_kerning, small_font_kerning_outline, small_font_kerning_plain, small_font_kerning_vanilla
};

const u16 *const puppyprint_offset_lut[][94] = {
    Dimbo_offset, all_font_offsets, all_font_offsets, all_font_offsets
};
